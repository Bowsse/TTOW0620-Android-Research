...
public final class BillingConstants {
    // SKUs for our products: beer (consumable)
    public static final String SKU_BEER = "beer";

    // SKU for our subscription (infinite beer)
    public static final String SKU_GOLD_MONTHLY = "monthly_sub";
    public static final String SKU_GOLD_YEARLY = "yearly_sub";

    private static final String[] IN_APP_SKUS = {SKU_BEER};
