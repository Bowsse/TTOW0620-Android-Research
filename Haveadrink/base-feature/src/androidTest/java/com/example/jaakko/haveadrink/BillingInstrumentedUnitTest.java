 ...
 */
package com.example.jaakko.haveadrink;
...
public class BillingInstrumentedUnitTest {
    ...
    @Rule
    public ActivityTestRule<com.example.jaakko.haveadrink.HaveADrinkActivity> mActivityRule =
            new ActivityTestRule<>(com.example.jaakko.haveadrink.HaveADrinkActivity.class);

    @Test
    public void testGasUsage() {
        final com.example.jaakko.haveadrink.HaveADrinkActivity activity = mActivityRule.getActivity();
        MainViewController controller = activity.getViewController();
        ImageView gasView = (ImageView) activity.findViewById(R.id.beer_gauge);
